...
class TestWindowsVdiVirtualDesktopsWin10(object):
    ...
    def test_windows_vdi_VDWin10_move_window_to_desktop_returns_None_for_move_not_ok(
        self, mocker
    ):
        mocker.patch("arrangeit.windows.vdi.VirtualDesktopsWin10._setup")
        mocker.patch(
    ...
    def test_windows_vdi_VDWin10_move_window_to_desktop_calls_byref_find(self, mocker):
        mocker.patch("arrangeit.windows.vdi.VirtualDesktopsWin10._setup")
        VALUE = "foobar"
        ORDINAL = 1
        mocker.patch(
    ...
    def test_windows_vdi_VDWin10_move_window_to_desktop_calls_FindDesktop(self, mocker):
        mocker.patch("arrangeit.windows.vdi.VirtualDesktopsWin10._setup")
        mocker.patch(
            "arrangeit.windows.vdi.VirtualDesktopsWin10.get_desktops",
            return_value=[(0, ""), (1, "barfoo")],
    ...
    def test_windows_vdi_VDWin10_move_window_to_desktop_returns_None_for_Switch(self, mocker):
        mocker.patch("arrangeit.windows.vdi.VirtualDesktopsWin10._setup")
        mocker.patch(
            "arrangeit.windows.vdi.VirtualDesktopsWin10.get_desktops",
            return_value=[(0, ""), (1, "barfoo")],
        ...
        returned = vd.move_window_to_desktop(2802, 1)
        assert returned is None
    ...
    def test_windows_vdi_VDWin10_move_window_to_desktop_returns_False(self, mocker):
        ...
        returned = vd.move_window_to_desktop(2803, 1)
